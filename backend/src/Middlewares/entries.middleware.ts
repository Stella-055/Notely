...
const{accessToken}=req.cookies
 ...
 jwt.verify(accessToken, process.env.ACCESS_TOKEN_SECRET!, (err: VerifyErrors | null, decoded: JwtPayload | String | undefined) => {
   if (err) {
...
export const validateEntryDetails =(req:Request,res:Response,next:NextFunction)=>{
