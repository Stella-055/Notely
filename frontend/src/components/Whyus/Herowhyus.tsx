const Herowhyus = () => {
  return (
    <main className="flex flex-col md:flex-row items-center max-md:text-center justify-between pt-16 pb-16 px-6 sm:px-10 md:px-24 max-w-7xl mx-auto w-full">
      <div className="flex flex-col items-center md:items-start">
        ...
        <div className="flex flex-col md:flex-row items-center mt-8 gap-3">
          ...
          <a
            className="text-blue-600 bg-blue-100 px-5 py-2 rounded-full text-sm font-medium hover:bg-indigo-200 transition"
            href="/siginup"
          >
            Get Started
          </a>
