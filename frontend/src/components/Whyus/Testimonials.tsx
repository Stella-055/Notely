...
const Testimonials = () => {
  return (
        ...
        <div  id="testimonials" className="flex flex-col items-center text-center">
            <p className="text-4xl font-bold max-w-160 mb-[72px]">Trusted by <span className="text-blue-600">30k+</span> Professionals</p>
