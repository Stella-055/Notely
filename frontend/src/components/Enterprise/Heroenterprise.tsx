...
const Heroenterprise = () => {
  return (
    <div className="w-full flex justify-center items-center flex-col pt-8">
      ...
      <h1 className="text-4xl md:text-6xl text-center font-semibold max-w-4xl mt-5 p-2 ">
        Notes that Work as Hard as Your Team
      </h1>
      <p className=" md:text-base max-md:px-2 text-center max-w-2xl mt-3">
        Empower your teams with secure, collaborative note-taking designed for
        the demands of modern enterprises. From shared knowledge bases to
        real-time updates, streamline communication and keep everyone aligned—no
        matter the size of your organization.
      </p>
