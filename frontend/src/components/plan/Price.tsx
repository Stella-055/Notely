    ...
    <div className="flex flex-col justify-center items-center mt-12">
          <div className="flex space-x-2 bg-white p-1 border border-gray-500/50 rounded-full text-sm w-80">
            <div className="flex items-center">
                <input type="radio" name="options" id="option1" className=" peer hidden" checked />
                <label htmlFor="option1" className="cursor-pointer rounded-full py-2 px-9 text-gray-500 transition-colors duration-200 peer-checked:bg-blue-600 peer-checked:text-white">Monthly</label>
            </div>
            <div className="flex items-center">
                <input type="radio" name="options" id="option2" className=" peer hidden" />
                <label htmlFor="option2" className="cursor-pointer rounded-full  py-2 px-9 text-gray-500 transition-colors duration-200 peer-checked:bg-blue-500 peer-checked:text-white">Yearly</label>
            </div>
        </div>
        <div className="flex flex-wrap items-center justify-center gap-8 mt-12 max-w-5xl">
            ...
            <div className="w-80 bg-white text-center text-gray-800/80 border border-gray-200 p-6 pb-16 rounded-lg">
                ...
                <button type="button" className="bg-blue-500 text-sm w-full py-2 rounded text-white font-medium mt-7 hover:bg-indigo-600 transition-all">
                    Get Started
                </button>
            </div>
        
            <div className="w-80 bg-blue-500 relative text-center text-white border border-gray-500/30 p-6 pb-14 rounded-lg">
                <p className="absolute px-3 text-sm -top-3.5 left-3.5 py-1 bg-white text-black  border-t-blue-500 border-t rounded-full">Most Popular</p>
                ...
                <button type="button" className="bg-white text-sm w-full py-2 rounded text-blue-500 font-medium mt-7 hover:bg-gray-200 transition-all">
                    Get Started
                </button>
            </div>
            ...
            <div className="w-80 bg-white text-center text-gray-800/80 border border-gray-200 p-6 rounded-lg">
                ...
                <button type="button" className="bg-blue-500 text-sm w-full py-2 rounded text-white font-medium mt-7 hover:bg-blue-600 transition-all">
                    Get Started
                </button>
            </div>
