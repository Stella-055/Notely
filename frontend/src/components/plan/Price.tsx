    ...
    <div className="flex flex-col justify-center items-center mt-12">
          <div className="flex space-x-2 bg-white p-1 border border-gray-500/50 rounded-full text-sm w-80">
            <div className="flex items-center">
                ...
                <label htmlFor="option1" className="cursor-pointer rounded-full py-2 px-9 text-gray-500 transition-colors duration-200 peer-checked:bg-blue-600 peer-checked:text-white">Option 1</label>
            </div>
            <div className="flex items-center">
                <input type="radio" name="options" id="option2" className=" peer hidden" />
                <label htmlFor="option2" className="cursor-pointer rounded-full  py-2 px-9 text-gray-500 transition-colors duration-200 peer-checked:bg-blue-500 peer-checked:text-white">Option 2</label>
            </div>
        </div>
