...
const Faqs = () => {
  return (
    <div className="flex flex-wrap justify-center items-center gap-4 mt-7 border-y py-7 mb-4">
        ...
        <p className="text-gray-800">Here are some of the most frequently asked questions</p>
        </div>
    ...
    >
      <AccordionItem value="item-1">
        <AccordionTrigger>How long is the free trial for paid plans?</AccordionTrigger>
