...
const Nav = () => {
  ...
  const DrawerList = (
    <Box sx={{ width: 250,py:7,px:4 }} role="presentation" onClick={toggleDrawer(false)}>
      <div className="flex ">
  ...
  return (
    <nav className="flex justify-around w-full py-5 border-b-black border-b fixed bg-gray-100 z-50 ">
      ...
      <div className="flex sm:hidden items-center"><IoMenu size={30} color="#3B82F6
" onClick={toggleDrawer(true)} /></div>
