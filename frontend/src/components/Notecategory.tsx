...
const Notecategory = () => {
  return (
    <div className="flex flex-col h-screen w-80 p-6 gap-2 border-r">
         <div className="flex justify-between"><h1 className="font-semibold ">ALL</h1><DropdownMenu>
  <DropdownMenuTrigger><FaArrowCircleDown size={20} color="#3B82F6"/></DropdownMenuTrigger>
  <DropdownMenuContent>
...
<div className="flex justify-between"><p className="text-gray-500 " style={{fontSize:".9rem"}}>4notes</p>
<div className="flex gap-1"><MdOutlinePlayArrow  color="grey"/><ImMenu4 color="grey"/></div>
</div>
<div className="flex items-center gap-3 max-w-md w-full">
      ...
      <div className="scroll-auto">
        <div className="shadow-gray-400 shadow p-2">
          <div className="flex justify-between"> <h1 className="text-gray-500">General</h1> <h1 className="text-gray-500">July 7th 2025</h1> </div> 
          <h1 className="font-bold">Atomic Habits</h1>
          <p className="text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut unde t!</p>
        </div>
