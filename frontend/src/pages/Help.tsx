    ...
    <div className="w-full">
      ...
      <div className="max-w-5xl w-full mx-auto p-10 text-gray-800">
            ...
            <p className="text-left mt-4">
               Reach out manually to us
                <a href="mailto:contact@example.com" className="text-blue-500 hover:underline">  helpdesk@notely.com</a>
            </p>
            <div className="grid md:grid-cols-3 mt-16">
                <div>
                    <svg className="text-blue-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="24"
                ...
                <div>
                    ...
                    <span className="text-blue-600 font-semibold">
                        221b Elementary Avenue, Nk
                    </span>
                </div>
                <div>
                    <svg className="text-blue-500 bg-indigo-500/20 p-2.5 aspect-square rounded-full size-10" width="21"
