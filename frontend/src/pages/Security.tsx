    ...
    <div className="w-full ">
      ...
      <div className="w-full flex flex-col justify-center items-center mt-4 h-96">
        ...
        <div className="bg-white text-sm border border-gray-300/60 p-6 rounded-md m-2 max-w-xl ">
            ...
            <h2 className="text-2xl font-semibold text-gray-800">Download our mobile app.</h2>
            <p className="text-gray-500 mt-1">Mobile banking app for IOS & Android to<br />manage your online money.</p>
            <div className="flex items-center gap-4 mt-6">
                <button className="active:scale-95 transition-all" type="button">
                    <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/appDownload/googlePlayBtnBlue.svg"
                        alt="googlePlayBtnBlue" />
                </button>
                <button className="active:scale-95 transition-all" type="button">
                    <img src="https://raw.githubusercontent.com/prebuiltui/prebuiltui/main/assets/appDownload/appleStoreBtnBlue.svg"
