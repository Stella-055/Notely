  ...
  return (
    <div className="w-full pt-32 flex justify-center items-center ">
      <div className="bg-white text-gray-500 max-w-96 mx-4 md:p-6 p-4 text-left text-sm rounded shadow-[0px_0px_10px_0px] shadow-black/10">
            ...
            <input id="password" value={newpassword} onChange={(e)=>setNewpassword(e.target.value)} className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4" type="email" placeholder="Enter your email" />
            <label htmlFor="confirmpassword"> Confirm Password</label>
            <input id="confirmpassword" value={confirmpassword} onChange={(e)=>setConfirmpassword(e.target.value)} className="w-full border mt-1 border-gray-500/30 focus:border-indigo-500 outline-none rounded py-2.5 px-4" type="email" placeholder="Enter your email" />
            <Button variant="contained"loading={isPending} fullWidth onClick={handlesubmit}>Update password</Button>
